...
import {DrainContract} from "../../../src/Contracts/truster/DrainContract.sol";
...
contract Truster is Test {
    ...
    function testExploit() public {
        /** EXPLOIT START **/
        DrainContract drainContract = new DrainContract(attacker, address(dvt),address(trusterLenderPool));
        drainContract.drainPool(); 
        /** EXPLOIT END **/
        validation();
    }
